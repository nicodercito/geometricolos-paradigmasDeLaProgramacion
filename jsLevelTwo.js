...
function onDrop(event) {
  const id = event
    ...
    if((draggableElement.id == "draggable-3" && event.target.id == "a")||(draggableElement.id == "draggable-2" && event.target.id == "c")||(draggableElement.id == "draggable-1" && event.target.id == "b")){
