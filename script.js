...
function onDrop(event) {
  const id = event
    ...
    if((draggableElement.id == "draggable-1" && event.target.id == "a")||(draggableElement.id == "draggable-3" && event.target.id == "c")||(draggableElement.id == "draggable-2" && event.target.id == "b")){
      if(draggableElement.id == "draggable-1" && event.target.id == "a"){
        document.getElementById("draggable-1").style.marginLeft = '-21px';
        document.getElementById("draggable-1").style.top = '0px';
      }
      ...
      if (draggableElement.id == "draggable-2" && event.target.id == "b"){
    ...
    if(validate == 3){
      alert("CORRECTO!, pasaste al siguiente nivel");
